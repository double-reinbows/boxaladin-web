    ...
    return (
      <div className="container-login">
        ...
        <div className="containerSignUp">
          ...
          <div className="containerSignUp__row1 mx-auto">
            <div className="containerSignUp__row1__img ">
              <img src={IconUser} alt="IconUser" className="containerSignUp__icon rounded mx-auto d-block" />
            </div>
          </div>

          <div className="containerSignUp__row2">

            <form className="form-horizontal containerSignUp__formsignup" onSubmit={e => this.signUp(e)}>
          ...
          <div className="containerSignUp__row3">
            <div className="containerSignUp__button">
              <div className="form-group">
